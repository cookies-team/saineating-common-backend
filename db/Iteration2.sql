...
INSERT INTO `Recipe` (`RecipeId`, `RecipeName`, `CookingId`) VALUES
(1, 'Asian chicken noodle soup', 1),
(2, 'Homemade falafel', 2),
(3, 'Banana, cashew and peanut Butter Ice-cream', 3),
(4, 'Miso rump roast with gravy and crushed potatoes', 4),
(5, 'Rump steak with mushroom sauce and baby potatoes', 5),
(6, 'Japanese chicken ramen', 6),
(7, 'Vegetarian pad Thai', 7),
(8, 'Pizza Jaffles', 8),
(9, 'Sticky soy beef winter bliss bowl', 9),
(10, 'Ultimate vegan breakfast wrap', 10),
(11, 'Healthy breakfast burger', 11),
(12, 'Bacon and egg breakfast mufins', 12);
